 ...
 * 
 * @see 'https://ourcodeworld.com/articles/read/280/creating-screenshots-of-your-app-or-the-screen-in-electron-framework'
 * 
 **/
module.exports = appScreenshot;

function appScreenshot(imageFormat, callback) {
     var _this = this;
